...
pub extern "C" fn text_editor_get_current_styles() -> *mut u8 {
    with_state_mut!(state, {
        ...
        //     fill_count (11), fill_multiple flag (12).
        //   - values: u32/f32/i32 indices 13..=30 (bytes 52..124) — align/dir/
        //     decoration/transform enums, font-family UUID (17..=20) + style (21)
        //     + weight (22), font_size f32 (23), font_weight i32 (24), font-variant
        //     UUID (25..=28), line_height f32 (29), letter_spacing f32 (30).
        //   - fills: fill_count × RawFillData, starting at byte 124.
        // Fixed section is 124 bytes; keep this layout in lockstep with the
        // decoders. (Capacity hint is approximate.)
        let mut bytes = Vec::with_capacity(124 + fill_bytes.len());
