...
import { markInteraction } from '@/lib/doc'
  ...
  return (
    ...
    >
      ...
      {/* ── Material (custom SkSL shader) controls ──
          Normally a material row opens the focus stage instead of this inline
          panel; this branch is the fallback if it's ever opened here. */}
      {isMaterial && material && (
        <MaterialEditor material={material} onChange={handleMaterialUpdate} />
      )}
    </FloatingPanelShell>
  )
}
