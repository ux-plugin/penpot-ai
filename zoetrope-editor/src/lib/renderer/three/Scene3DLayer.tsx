...
function renderSceneIntoBox(
  ...
  // The viewport is the plan's slice of the box; the clear above covers the whole box, so
  // whatever the slice doesn't reach stays as the letterbox (only a crop grown past its
  // frame leaves any). GL's origin is bottom left, so the plan's top-down fy flips.
  if (plan) {
