...
import SocialLoginItem from '@auth/components/SocialLoginItem';
import { AddSocialAccountMenu } from '@auth/components/AddSocialAccountMenu.tsx';
import ProfileSection from '@user/components/ProfileSection'; // Import the new component
import { StatusDetailed } from '@status/components/StatusDetailed';
