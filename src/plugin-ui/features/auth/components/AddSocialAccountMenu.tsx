...
import { FigmaIcon } from '@assets/icons/FigmaIcon'; // Import your custom FigmaIcon
import { GitHubIcon } from '@assets/icons/GithubIcon';
import { useGitHubConnect } from "../api/connectGithub.ts"; // Import your custom GitHubIcon
import { useFigmaConnect } from "../api/connectFigma.ts"; // Import useFigmaConnect
import { Loader2 } from "lucide-react"; // Import Loader2
import { showErrorToast, showSuccessToast } from '@shared/utils/showErrorToast';
