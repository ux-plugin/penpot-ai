...
// Blend mode schema
val blendModeSchema: JsonSchemaElement =
...
// RGB color schema
val rgbColorSchema: JsonSchemaElement =
...
// RGBA color schema
val rgbaColorSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
// Vector schema
val vectorSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
// Vector path schema
val vectorPathSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
// Color stop schema
val colorStopSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
// Paint schemas
// Solid paint schema
val solidPaintSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val linearGradientPaintSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
        ...
        .addProperty(
            ...
            JsonArraySchema.builder()
                ...
                .items(JsonArraySchema.builder().items(JsonNumberSchema.builder().build()).build())
                .build(),
        )
        .addProperty(
            "gradientStops",
            JsonArraySchema.builder().description("Color stops for the gradient").items(colorStopSchema).build(),
        )
        .addProperty("blendMode", blendModeSchema)
        .addBooleanProperty("visible", "Whether the paint is visible")
        .addNumberProperty("opacity", "Opacity value between 0 and 1")
...
val radialGradientPaintSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
// Image paint schema
val imagePaintSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val paintSchema: JsonSchemaElement =
...
val dropShadowEffectSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val innerShadowEffectSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val backgroundBlurEffectSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val layerBlurEffectSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val effectSchema: JsonSchemaElement =
    JsonAnyOfSchema.builder()
...
val strokeWeightSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val cornerRadiusSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
// Constraints schema
val constraintsSchema: JsonSchemaElement =
    JsonObjectSchema.builder()
...
val frameNodeJsonSchema: ResponseFormat =
            ...
            JsonSchema.builder()
                ...
                .rootElement(
                    JsonObjectSchema.builder()
                        ...
                        .addProperty(
                            "fills",
                            JsonArraySchema.builder().description("List of fill paints").items(paintSchema).build(),
                        )
                        .addProperty(
                            "strokes",
                            JsonArraySchema.builder().description("List of stroke paints").items(paintSchema).build(),
                        )
                        .addProperty("strokeWeight", strokeWeightSchema)
                        .addProperty("cornerRadius", cornerRadiusSchema)
                        .addProperty("constraints", constraintsSchema)
                        .addProperty(
                            "strokeGeometry",
                            JsonArraySchema.builder()
                                .description("Vector paths for stroke geometry")
                                .items(vectorPathSchema)
                                .build(),
                        )
                        .addProperty(
                            "fillGeometry",
                        ...
                        .addProperty(
                            "effects",
                            JsonArraySchema.builder().description("List of effects").items(effectSchema).build(),
                        )
