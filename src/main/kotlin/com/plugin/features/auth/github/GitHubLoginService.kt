...
constructor(
    ...
    @ConfigProperty(name = "auth.github.client-id") private var clientId: String,
    @ConfigProperty(name = "auth.github.client-secret") private var clientSecret: String,
    @ConfigProperty(name = "auth.github.login-redirect-uri") private var loginRedirectUri: String,
    @ConfigProperty(name = "auth.github.connect-redirect-uri") private var connectRedirectUri: String,
    @ConfigProperty(name = "auth.github.connect.result-key-prefix") private var resultKeyPrefix: String,
    @ConfigProperty(name = "auth.github.login.random-key.max-retries") private var randomKeyGenerationMaxRetries: Int,
    @ConfigProperty(name = "auth.github.login.timeout-sec") private var loginTimeout: Long,
    ...
    @ConfigProperty(name = "auth.github.read-token.redis-key-prefix") private var readTokenPrefix: String,
    @ConfigProperty(name = "auth.github.user-id.redis-key-prefix") private var userIdPrefix: String,
    @ConfigProperty(name = "auth.github.write-token.redis-key-prefix") private var writeTokenPrefix: String,
    ...
    suspend fun connectSocialProfile(code: String, state: String) {
        ...
        try {
            ...
            val socialProfile = authRepository.getSocialLogin("${userInfo.id}", SocialProvider.GITHUB).awaitSuspending()
