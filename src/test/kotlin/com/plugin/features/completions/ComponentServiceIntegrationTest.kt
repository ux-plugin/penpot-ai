...
class ComponentServiceIntegrationTest {
    ...
    fun testGetCompletion() {
        ...
        val aiCompletionJson = """{"id":"test-frame-id","name":"Test Frame","width":200,"height":200}"""
    ...
    fun testCreateCompletionWithoutSavingPermission() {
        ...
        sessionFactory.withTransaction { session, _ ->
            ...
            .indefinitely()
            .let { count ->
                assert(count == 0L) { "Expected 0 completions for user without saving permission, but found $count" }
            }
    }
