...
//    override fun getConfigOverrides(): Map<String, String> = mapOf("auth.github.login.timeout-sec"
// to "2")
// }
//
...
//            .body(
//                "loginUrl",
//                containsString("${URLEncoder.encode(GitHubAccessScope.USER_EMAIL.value,
// "UTF-8")}"),
//            )
