...
//    override fun getConfigOverrides(): Map<String, String> = mapOf("auth.figma.login.timeout-sec"
// to "2")
// }
//
...
// $token").`when`().get("/auth/figma/access-token").then().statusCode(408)
//    }
//
//    // @Test
...
//            .body(
//                "loginUrl",
//                containsString("${URLEncoder.encode(FigmaAccessScope.CURRENT_USER_READ.value,
// "UTF-8")}"),
//            )
//            .body(
//                "loginUrl",
//                containsString("${URLEncoder.encode(FigmaAccessScope.FILE_CONTENT_READ.value,
// "UTF-8")}"),
//            )
